...
async function render(){
  const version=++renderVersion;$('size-value').textContent=`칸의 ${state.size}%`;$('opacity-value').textContent=`${state.opacity}%`;$('char-count').textContent=`${segment(state.content).length.toLocaleString()}자`;
